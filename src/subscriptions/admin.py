...
class SubscriptionAdmin(admin.ModelAdmin):
    ...
    def mark_as_paid(self, request, queryset):
        ...
        msg = ungettext(
            u'%(count)d inscrição doi marcada com paga.',
            u'%(cound)d inscrições foram marcadas como pagas.',
            count
        ) % {'count': count}
    ...
    def get_urls(self):
        ...
        extra_url = patterns('',
                             # Envolvemos a nossa view em 'admin_view' por que
                             # ela faz o controle de permissões, e cache
        ...
        # A ordem é importante. As URLs originais do admin são muito
        # permissivas e acabam sendo encontradas antes das nossas se elas
        # estiverem na frente.
